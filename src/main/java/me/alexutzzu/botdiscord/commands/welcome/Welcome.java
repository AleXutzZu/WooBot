package me.alexutzzu.botdiscord.commands.welcome;
...
import me.alexutzzu.botdiscord.utils.pojos.guild.WelcomeSettings;
...
public class Welcome extends Command implements AdditionalMethods {
    public Welcome(MongoDatabase mongoDatabase){
        this.category = new me.alexutzzu.botdiscord.utils.categories.Welcome();
        this.cooldown = 10;
        this.name = "welcome";
        this.guildOnly = true;
